...
# ~ ln = Line3(Point3(0, 0, 0), Point3(0, 1, 0))
# ~ print(Sphere(Point3(10, 10, 10), 5.0).intersect(ln))
# ~ print(LineSegment2(Point2(0, 0), Point2(1,1)).intersect(Circle(Point2(10, 10), 1.0)))
r = Quaternion.new_interpolate(Quaternion(1, 0, 0, 0), Quaternion(1, 1, 1, 1), .5)
print(r)
